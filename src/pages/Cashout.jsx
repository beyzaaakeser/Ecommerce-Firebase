    ...
    useEffect(() => {
        const unsubscribeAuth = onAuthStateChanged(auth, (user) => {
            if (user) {
                ...
                const unsubscribeUserData = onSnapshot(userRef, (snapshot) => { // Gerçek zamanlı güncellemeler için
                    if (snapshot.exists()) {
    ...
    const cashoutSubmit = async (e) => {
        ...
        if (user) {
            ...
            try {
                ...
                setAddress('');
                dispatch({type: 'EMPTY'});
                setSuccessMsg('Siparişiniz başarıyla verilmiştir. 3 saniye sonra anasayfaya yönlendirileceksiniz.');
            ...
            <div className='container cashoutContainer'>
                ...
                <form autoComplete="off" className='form-group' onSubmit={cashoutSubmit}>
                    ...
                    <input type="number" className='form-control' required
                           ...
                           placeholder='örneğin 03123456789'/>
                    ...
                    <input type="number" className='form-control' required
                           value={Number(totalPrice).toFixed(2)} disabled/>
